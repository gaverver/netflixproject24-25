...
std::vector<std::string> LastNWordsUsers(std::string uid, int N) {
...
TEST(DBFileTesting, UpdateUsr1) {
    ...
    for (unsigned long int i=1; i<4; ++i) {
        std::vector<std::string> mids = {std::to_string(100+i),std::to_string(101+i),std::to_string(102+i)};
        //updating some user with some ids
        dbf.updateUser(std::to_string(i),mids);
...
TEST(DBFileTesting, UpdateUsr2) {
    ...
    //adding some movies to 3 different users
    for (int i=1; i<4; ++i) {
        std::vector<std::string> mids = {"101","102","103"};
        //updating some user with some ids
        dbf.updateUser(std::to_string(i), mids);
    }
    ...
    std::vector<std::string> mid1 = {"101"};
...
TEST(DBFileTesting, UpdateMovie1) {
    ...
    for (unsigned long int i=1; i<4; ++i) {
        std::vector<std::string> uids = {std::to_string(100+i),std::to_string(101+i),std::to_string(102+i)};
...
TEST(DBFileTesting, UpdateMovie2) {
    ...
    //adding again movie to some users
    std::vector<std::string> uid1 = {"101"};
...
TEST(DBFileTesting, FindUser) {
    ...
    std::vector<std::string> emptyMids = {};
    ...
    std::vector<std::string> mids1 = {"100","101","102"};
    dbf.updateUser("1",mids1);
    ...
    std::vector<std::string> mids2 = {"100","201","202"};
...
TEST(DBFileTesting, FindMovie) {
    ...
    std::vector<std::string> emptyUids = {};
    ...
    std::vector<std::string> uids1 = {"100","101","102"};
    dbf.updateMovie("1",uids1);
    ...
    //add some more users
    std::vector<std::string> uids2 = {"100","201","202"};
    dbf.updateMovie("1",uids2);
    //check if the findMovie works
    std::vector<std::string> uidsCheck2 = dbf.findMovie("1");
...
TEST(DBFileTesting, GetCommonMovies1) {
    ...
    std::vector<std::string> mids1 = {};
    std::vector<std::string> mids2 = {"100","200","300"};
    //add the movies
    dbf.updateUser("1",mids1);
    ...
    std::vector<std::string> mids3 = {"50","150","250"};
    std::vector<std::string> mids4 = {"400","500","600"};
    //add the movies
...
TEST(DBFileTesting, GetCommonMovies2) {
    ...
    std::vector<std::string> intersection1 = {"100"};
    //list of movies from users 1,2
    std::vector<std::string> mids1 = {"100","400","500"};
    std::vector<std::string> mids2 = {"100","200","300"};
    //add the movies
    dbf.updateUser("1",mids1);
    dbf.updateUser("2",mids2);
    ...
    std::vector<std::string> intersection2 = {"300"};
    //list of movies from users 3,4
    std::vector<std::string> mids3 = {"100","200","300"};
    std::vector<std::string> mids4 = {"300","400","500"};
    //add the movies
    dbf.updateUser("3",mids3);
    dbf.updateUser("4",mids4);
    //check intersection
    ...
    std::vector<std::string> intersection3 = {"200","300"};
    //list of movies from users 5,6
    std::vector<std::string> mids5 = {"100","300","200","600"};
    std::vector<std::string> mids6 = {"200","300","500","700"};
    //add the movies
...
TEST(DBFileTesting, GetCommonMovies3) {
    ...
    std::vector<std::string> intersection1 = {"100"};
    //list of movies from users 1,2
    std::vector<std::string> mids1 = {"100"};
    std::vector<std::string> mids2 = {"100"};
    //add the movies
    dbf.updateUser("1",mids1);
    dbf.updateUser("2",mids2);
    //check intersection
    ...
    //second intersection result
    std::vector<std::string> intersection2 = {"100","200","300","400","500"};
    //list of movies from users 3,4
    std::vector<std::string> mids3 = {"100","500","300","400","200"};
    std::vector<std::string> mids4 = {"200","100","400","500","300"};
    //add the movies
    dbf.updateUser("3",mids3);
    dbf.updateUser("4",mids4);
    //check intersection
...
TEST(DBFileTesting, GetAllMovies) {
    ...
    std::vector<std::string> movies1ex = {};
    //first output
    std::vector<std::string> movies1out = dbf.getAllMovies();
    //check movie list equality
    EXPECT_EQ(movies1ex,movies1out);
    
    //add some movies
    std::vector<std::string> mids1 = {"100", "200", "300", "400"};
    dbf.updateUser("1", mids1);
    //expected second output
    std::vector<std::string> movies2ex = {"100", "200", "300", "400"};
    //second output
    std::vector<std::string> movies2out = dbf.getAllMovies();
    //check movie list equality
    EXPECT_EQ(movies2ex,movies2out);
    
    //add some movies to the same user
    std::vector<std::string> mids2 = {"300", "400", "500", "600"};
    dbf.updateUser("1", mids2);
    //expected third output
    std::vector<std::string> movies3ex = {"100", "200", "300", "400", "500", "600"};
    //third output
    std::vector<std::string> movies3out = dbf.getAllMovies();
    //check movie list equality
    EXPECT_EQ(movies3ex,movies3out);

    //add some movies to different user
    std::vector<std::string> mids3 = {"800", "700", "100"};
    dbf.updateUser("2", mids3);
    //expected fourth output
    std::vector<std::string> movies4ex = {"100", "200", "300", "400", "500", "600", "700", "800"};
    //foourth output
    std::vector<std::string> movies4out = dbf.getAllMovies();
    //check movie list equality
...
TEST(DBFileTesting, isUserExists) {
    ...
    std::vector<std::string> movies = {"1"};
...
TEST(DBFileTesting, DeleteMovies) {
    ...
    EXPECT_EQ(dbf.findUser("1"), (std::vector<std::string>{"101","102","103","104","105","106","107","108"}));
    //remove first three
    dbf.deleteMovies("1",{"101","103","102"});
    EXPECT_EQ(dbf.findUser("1"), (std::vector<std::string>{"104","105","106","107","108"}));
    //remove middle three
    dbf.deleteMovies("1",{"106","107","105"});
    EXPECT_EQ(dbf.findUser("1"), (std::vector<std::string>{"104","108"}));
    //add some ids
    dbf.updateUser("1",{"100","106","105","101","109","110"});
    //remove the ones in odd index
    dbf.deleteMovies("1",{"100","104","106","109"});
    EXPECT_EQ(dbf.findUser("1"), (std::vector<std::string>{"101","105","108","110"}));
    //delete nothing
    dbf.deleteMovies("1",{});
    EXPECT_EQ(dbf.findUser("1"), (std::vector<std::string>{"101","105","108","110"}));
...
TEST(DBFileTesting, DeleteUsers) {
    ...
    EXPECT_EQ(dbf.findMovie("1"), (std::vector<std::string>{"101","102","103","104","105","106","107","108"}));
    //remove first three
    dbf.deleteUsers("1",{"101","103","102"});
    EXPECT_EQ(dbf.findMovie("1"), (std::vector<std::string>{"104","105","106","107","108"}));
    //remove middle three
    dbf.deleteUsers("1",{"106","107","105"});
    EXPECT_EQ(dbf.findMovie("1"), (std::vector<std::string>{"104","108"}));
    //add some ids
    dbf.updateMovie("1",{"100","106","105","101","109","110"});
    //remove the ones in odd index
    dbf.deleteUsers("1",{"100","104","106","109"});
    EXPECT_EQ(dbf.findMovie("1"), (std::vector<std::string>{"101","105","108","110"}));
    //delete nothing
    dbf.deleteUsers("1",{});
    EXPECT_EQ(dbf.findMovie("1"), (std::vector<std::string>{"101","105","108","110"}));
    //delete something that doesn't exists
